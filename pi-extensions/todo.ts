...
export default function (pi: ExtensionAPI) {
	...
	pi.registerTool({
		...
		label: "Todo",
		description:
			"Track task progress for the user. Use add to break work into steps, list to review, toggle to mark completed tasks, and clear only when finished or starting a new plan. Actions: list, add (text), toggle (id), clear.",
